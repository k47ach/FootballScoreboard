...
public final class ErrorMessageConstants {
    ...
    public static final String ILLEGAL_CHARACTER_ERROR_MESSAGE = "Only letter characters are allowed";
    public static final String SAME_NAME_ERROR_MESSAGE = "Team names can not be the same";
